# Repository for Project -- Part 1 and Part 1

The goal of this repository is to serve as a template for the project developed during the ARQSOFT course of the MEI Program, edition 2022/23.

**The instructions of your teachers will always prevail over what is stated in this readme file.**

## Folders for Each Task

Place the artifacts for each part in the specific folder ("part 1" or "part 2"). Create and manage subfolders as necessary.
